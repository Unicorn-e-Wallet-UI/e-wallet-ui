...
const SignUpPage = () => {
    ...
    return(
         ...
         <>
             <Container images={<img src={SignUpImage} style={{width:"100"}} alt="Sigupimage"/>}
             forms={
                <>
                <form>
                    <div>
                    ...
                    <InputFields name={"email"} type={"email"} value={signupData.password} holder={"Email:"}handleChange={handleChange}/>
                    <InputFields name={"password"} type={"password"} value={signupData.email} holder={"Password:"} handleChange={handleChange}/>
